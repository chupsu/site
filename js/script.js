...
// ('module/input-placeholder-target-null.js');
...
if (document.querySelector('.cards__img-slider')) {
  const productCards = document.querySelectorAll('.cards__img-slider');
  productCards.forEach((el) => {
    let productCard = new Swiper(el, {
      slidesPerView: 1,
      effect: 'fade',
