...
if (document.querySelector('.rarity__filter')) {
  var filterBtns = new Swiper('.rarity__filter', {
    ...
    slidesPerView: 'auto',
    freeMode: true,
    wrapperClass: 'rarity__btns',
    slideClass: 'rarity__btn',
    scrollbar: {
      el: '.rarity__scrollbar',
      draggable: true,
    },
    mousewheel: true,
    breakpoints: {
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  const tabs = document.querySelectorAll('.rarity__btn'),
    ...
    tabsParent = document.querySelector('.rarity__btns');
  ...
  tabsParent.addEventListener('click', (event) => {
    ...
    if (target && target.classList.contains('rarity__btn')) {
      tabs.forEach((item, i) => {
        if (target == item) {
          hideTabContent();
          showTabContent(i);
