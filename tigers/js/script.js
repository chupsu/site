...
window.addEventListener('DOMContentLoaded', () => {
  new WOW().init();
  OverlayScrollbars(document.querySelectorAll('.rarity__filter'), {});
  //---------- Tabs
  const tabs = document.querySelectorAll('.rarity__filter-btn'),
    tabsContent = document.querySelectorAll('.rarity-slider'),
    tabsParent = document.querySelector('.rarity__filter');
  ...
  tabsParent.addEventListener('click', (event) => {
    ...
    if (target && target.classList.contains('rarity__filter-btn')) {
      tabs.forEach((item, i) => {
        if (target == item) {
          hideTabContent();
          showTabContent(i);
